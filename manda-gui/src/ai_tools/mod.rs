//! Built-in tools for the MANDA AI chat overlay.
//!
...
//! two path helpers.
//!
//! Submodule layout (matches the long-term plan in `manda-gui/AGENTS.md`):
//!
...
mod tests {
    ...
    fn eval_05_shell_exec_basic() {
        ...
        let out = execute(
            "shell_exec",
            &serde_json::json!({"command": "echo hello_manda"}),
            &mut cwd,
            &cfg,
            &cancel,
        )
