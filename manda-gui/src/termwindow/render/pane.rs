...
use crate::termwindow::render::{
    forces_opaque_manda_tui_background, same_hyperlink, CursorProperties, LineQuadCacheKey,
...
impl crate::TermWindow {
    ...
    pub fn paint_pane(
        ...
        */
        ...
        let force_opaque_background = forces_opaque_manda_tui_background(&pos.pane);
