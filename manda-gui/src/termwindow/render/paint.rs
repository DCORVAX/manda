...
use crate::termwindow::render::forces_opaque_manda_tui_window_background;
...
impl crate::TermWindow {
    ...
    pub fn paint_pass(&mut self) -> anyhow::Result<()> {
        ...
        let force_opaque_window_background = forces_opaque_manda_tui_window_background(&panes);
    ...
    fn paint_tab_bell_indicators(
        ...
        // MANDA renders unread bell state inline in the bundled format-tab-title
