...
impl super::TermWindow {
    ...
    fn maybe_handle_native_line_editor_shortcut(
        ...
        // arrow keys into MANDA-specific sequences (`\x1b[99X~`, Ctrl-B/F/A/E)
        ...
        match (&window_key.key, mods) {
            (WK::LeftArrow | WK::ApplicationLeftArrow, Modifiers::SHIFT) => {
                ...
                // _manda_select_left_char widget activates REGION_ACTIVE and
            ...
            {
                // Collapse selection leftward. The shell-side _manda_mv_backward_char widget
