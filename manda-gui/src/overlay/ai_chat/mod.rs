//! AI conversation overlay for MANDA.
//!
...
// Vocabulary used in this overlay (see also `manda-gui/AGENTS.md`):
...
//   `manda::assistant_config::AssistantConfig`).
