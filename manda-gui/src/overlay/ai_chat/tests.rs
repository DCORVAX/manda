...
mod markdown_tests {
    ...
    fn shell_exec_read_only_commands_skip_approval() {
        for command in [
            ...
            "gh pr diff 456",
            "gh pr checks 456",
            "gh repo view DCORVAX/manda",
            "gh release list",
            "gh release view v0.10.0",
            "gh workflow list",
            "gh run list",
            "gh search issues manda",
            "gh search prs --repo DCORVAX/manda",
            "gh auth status",
            "gh status",
            "gh api repos/DCORVAX/manda",
            "gh api -X GET repos/DCORVAX/manda",
            "gh api --method=GET repos/DCORVAX/manda",
            ...
            "curl https://api.github.com/repos/DCORVAX/manda",
            "curl -s https://api.github.com/repos/DCORVAX/manda",
            "curl -sL https://api.github.com/repos/DCORVAX/manda/issues",
            "curl -X GET https://api.github.com/repos/DCORVAX/manda",
            "curl --request=GET https://api.github.com/repos/DCORVAX/manda",
    ...
    fn shell_exec_dangerous_commands_require_approval() {
        for command in [
            ...
            "gh auth login",
            "gh auth logout",
            "gh api -X POST repos/DCORVAX/manda/issues",
            "gh api --method POST repos/DCORVAX/manda/issues",
            "gh api repos/DCORVAX/manda/issues -F title=hi",
