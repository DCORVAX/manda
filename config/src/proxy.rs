//! System proxy detection for `manda update`-style curl invocations.
//!
//! When MANDA is launched from the menu bar or a notification, the process
...
//! and exposes it for the update code paths in both `manda` and `manda-gui`.
//!
