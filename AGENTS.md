...
- The marketing landing page lives in `web/` inside this repository (`web/index.html`, single self-contained static file) and deploys to `manda-term.vercel.app`; point Vercel at the `web/` directory as the project root. Do not add instructions for the removed `website/` tree.
