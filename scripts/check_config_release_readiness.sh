...
MANDA_LUA="assets/macos/Manda.app/Contents/Resources/manda.lua"
...
if ! file_contains_literal 'config_version.txt' "$MANDA_LUA"; then
	echo "Expected $MANDA_LUA to read config_version.txt" >&2
	exit 1
fi
