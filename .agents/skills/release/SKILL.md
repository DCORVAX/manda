...
7. **stage:homebrew-tap** — `repository_dispatch` to `DCORVAX/homebrew-tap` triggering `bump.yml`. Polls the cask file in `Casks/manda.rb` for the new version (default 12 attempts × 15s).
