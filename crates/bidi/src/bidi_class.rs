...
pub const BIDI_CLASS: &'static [(char, char, BidiClass)] = &[
    ...
    ('\u{1e800}', '\u{1e8c4}', BidiClass::RightToLeft), // Lo [197] MENDE KIMANDAI SYLLABLE M001 KI..MENDE KIMANDAI SYLLABLE M060 NYON
    ('\u{1e8c5}', '\u{1e8c6}', BidiClass::RightToLeft), // Cn   [2] <reserved-1E8C5>..<reserved-1E8C6>
    ('\u{1e8c7}', '\u{1e8cf}', BidiClass::RightToLeft), // No   [9] MENDE KIMANDAI DIGIT ONE..MENDE KIMANDAI DIGIT NINE
    ('\u{1e8d0}', '\u{1e8d6}', BidiClass::NonspacingMark), // Mn   [7] MENDE KIMANDAI COMBINING NUMBER TEENS..MENDE KIMANDAI COMBINING NUMBER MILLIONS
